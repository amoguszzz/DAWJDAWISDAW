    ...
    function self.NewWindow(data)
        ...
        do
            ...
            do
                ...
                local b64map = {}
                for i = 1, 64 do
                b64map[string.sub(base64_chars, i, i)] = i - 1
                end

                local result = {}
                local acc = 0
                local b64len = string.len(data)
                local k = 0
                ...
                acc = bit32.bor(acc, bit32.lshift(v, (18 - k)))
                k = k + 6
                if k >= 8 then
                    table.insert(result, string.char(bit32.band(bit32.rshift(acc, (k - 8)), 0xFF)))
                    k = k - 8
                end
                end
